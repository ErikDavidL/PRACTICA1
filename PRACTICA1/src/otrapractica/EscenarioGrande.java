...
public class EscenarioGrande extends Escenario {
    ...
    public String[][] crearEscenario(){
        ...
        for (int w=0; w < fila ; w++) {
            for (int z=0; z < columna-1; z++) { 
                ...
                System.out.print("| Seleccione un tipo de terreno para la casilla de la fila["+x+"] columna["+y+"] = ");
    ...
    public String[][] generarEscenario(){
        ...
        System.out.println("\n 1. \033[37mMontañas: \033[32m▲▲▲▲▲▲▲ \033[37m           2. Terreno Plano: \033[31m▓▓▓▓▓▓▓ \033[37m          3. Agua: \033[36m≈≈≈≈≈≈≈ \033[37m          4. Base: \033[35m║║║║║║║ \033[37m");
        return escenario;
    }
    ...
    //llamar a un objeto de la clase opcion vehiculo
    OpcionVehiculo dibujoVehiculo;
    //metodo constructor del objeto
    public EscenarioGrande(OpcionVehiculo dibujoVehiculo) {
    ...
    public String dibujoVehiculo1(){
        if(dibujoVehiculo.dibujarVehiculo1() == "Tanque"){
            escenario[5][3] = "\033[35m║║\033[33m=╧=\033[35m║║\033[37m";
        }else{
            escenario[5][3] = "\033[35m║\033[33m__▲__\033[35m║\033[37m";
        }        
        return escenario[5][3];
    }
   
    public String dibujoVehiculo2(){
        if(dibujoVehiculo.dibujarVehiculo2() == "Tanque"){
            escenario[5][4] = "\033[35m║║\033[34m=╧=\033[35m║║\033[37m";
        }else{
            escenario[5][4] = "\033[35m║\033[34m__▲__\033[35m║\033[37m";
        }                               
        return escenario[5][4];
    }
    
    public String dibujoVehiculo3(){
        if(dibujoVehiculo.dibujarVehiculo3() == "Tanque"){
            escenario[5][5] = "\033[35m║║\033[37m=╧=\033[35m║║\033[37m";
        }else{
            escenario[5][5] = "\033[35m║\033[37m__▲__\033[35m║\033[37m";
        }                    
        return escenario[5][5];
    }
    ...
    public String enemigo2(){
            escenario[0][4] = "\033[35m ▼▼▼▼▼ \033[37m";
        return escenario[0][4];
    }
    public String enemigo3(){
            escenario[0][5] = "\033[35m ▼▼▼▼▼ \033[37m";
        return escenario[0][5];
    }
    ...
    System.out.println("| SELECCIONE LA POSICIÓN A DONDE SE MOVERÁ EL VEHICULO ");
    ...
    //metodo donde se guardan los metodos de movimiento de 3
