...
public class EscenarioMediano extends Escenario {
    ...
    String arregloEscenario[][];
    public String[][] datosArregloEscenario(){
    ...
    public EscenarioMediano(OpcionVehiculo dibujoVehiculo) {
        this.dibujoVehiculo = dibujoVehiculo;
    }
    public String dibujoVehiculo1(){
        if(dibujoVehiculo.dibujarVehiculo1() == "Tanque"){
            escenario[4][2] = "\033[35m║║\033[33m=╧=\033[35m║║\033[37m";
        }else{
            escenario[4][2] = "\033[35m║\033[33m__▲__\033[35m║\033[37m";
        }        
        return escenario[4][2];
    }
   
    public String dibujoVehiculo2(){
        if(dibujoVehiculo.dibujarVehiculo2() == "Tanque"){
            escenario[4][3] = "\033[35m║║\033[34m=╧=\033[35m║║\033[37m";
        }else{
            escenario[4][3] = "\033[35m║\033[34m__▲__\033[35m║\033[37m";
        }                               
        return escenario[4][3];
    }
    
    public String dibujoVehiculo3(){
        if(dibujoVehiculo.dibujarVehiculo3() == "Tanque"){
            escenario[4][4] = "\033[35m║║\033[37m=╧=\033[35m║║\033[37m";
        }else{
            escenario[4][4] = "\033[35m║\033[37m__▲__\033[35m║\033[37m";
        }                    
        return escenario[4][4];
    }
